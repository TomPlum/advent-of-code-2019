...
class PortalTest {
    ...
    fun hasEntrancePositive() {
        val first = PortalEntrance(WarpCode('F', Point2D(4, 11), 'G', Point2D(4, 10)), Point2D(4, 12), 25, 25)
        val second = PortalEntrance(WarpCode('F', Point2D(8, 0), 'G', Point2D(8, -1)), Point2D(8, 1), 25, 25)
    ...
    fun warpFromOuterShouldDecreaseLevel() {
        val outer = PortalEntrance(WarpCode('F', Point2D(0, 11), 'G', Point2D(1, 11)), Point2D(2, 11), 25, 25)
        val inner = PortalEntrance(WarpCode('F', Point2D(10, 16), 'G', Point2D(10, 17)), Point2D(10, 18), 25, 25)

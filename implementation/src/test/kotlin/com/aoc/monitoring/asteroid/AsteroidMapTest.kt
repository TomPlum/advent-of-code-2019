...
class AsteroidMapTest {
    ...
    fun optimalMappingStationSectorExampleOne() {
        val map = AsteroidMap(TestInputReader().readInputAsString("/asteroid/example-1.txt").value)
    ...
    fun optimalMappingStationSectorExampleTwo() {
        val map = AsteroidMap(TestInputReader().readInputAsString("/asteroid/example-2.txt").value)
        val optimalSector = map.getOptimalAsteroidMappingStationSector()
    ...
    fun optimalMappingStationSectorExampleThree() {
        val map = AsteroidMap(TestInputReader().readInputAsString("/asteroid/example-3.txt").value)
        val optimalSector = map.getOptimalAsteroidMappingStationSector()
    ...
    fun optimalMappingStationSectorExampleFour() {
        val map = AsteroidMap(TestInputReader().readInputAsString("/asteroid/example-4.txt").value)
        val optimalSector = map.getOptimalAsteroidMappingStationSector()
    ...
    fun optimalMappingStationSectorExampleFive() {
        val map = AsteroidMap(TestInputReader().readInputAsString("/asteroid/example-5.txt").value)
        val optimalSector = map.getOptimalAsteroidMappingStationSector()
